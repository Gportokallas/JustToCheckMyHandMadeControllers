...
import com.example.demo.pojos.Status;
...
public class DemoApplication implements CommandLineRunner //to run code in application start up
{
    ...
    public void run(String... args) throws Exception {
        ...
        User user1 = new User("giorgos","portokallas",4, Status.LOYAL);

userRepository.save(user1);
userRepository.save(new User("kwstas","petaloudas",4,Status.GOLD));
